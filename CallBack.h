...
class CallbackBaseDP {
public:
	virtual void execute(P1 _p1) = 0;
	virtual ~CallbackBaseDP() {};
};
...
class CallbackP1DP : public CallbackBaseDP< P1 >
{
public:

	typedef void (Class::*Method)(P1);
	CallbackP1DP(Class* _class_instance, Method _method)
	{
	   _obj = _class_instance;
	   _func = _method;
	};

	void operator()(P1 _p1) { return (_obj->*_func)(_p1); }
	void execute(P1 _p1) { return operator()(_p1); }
